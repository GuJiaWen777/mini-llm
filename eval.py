...
from model.MiniLLMModel import MiniLLMConfig, MiniLLMForCausalLM
...
def init_model(args):
    ...
    print(
        f"MiniLLM模型参数: {sum(p.numel() for p in model.parameters()) / 1e6:.2f} M(illion)"  # ！修正：原残留MiniMind命名
    )
